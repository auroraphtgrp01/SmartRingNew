export class Constants {
  ...
  static COMMAND_BYTE = {
    ...
    // delete 
    DELETE_SPORT_HISTORY_COMMAND: new Uint8Array([0x05, 0x40, 0x07, 0x00, 0x02, 0x15, 0xF9]),
    DELETE_SLEEP_HISTORY_COMMAND: new Uint8Array([0x05, 0x41, 0x07, 0x00, 0x02, 0xA1, 0x8F]),
    DELETE_HEART_HISTORY_COMMAND: new Uint8Array([0x05, 0x42, 0x07, 0x00, 0x02, 0x7D, 0x14]),
    DELETE_BLOOD_PRESSURE_HISTORY_COMMAND: new Uint8Array([0x05, 0x43, 0x07, 0x00, 0x02, 0xC9, 0x62]),
    DELETE_COMPREHENSIVE_MEASUREMENT_COMMAND: new Uint8Array([0x05, 0x44, 0x07, 0x00, 0x02, 0xE4, 0x33])
  }
