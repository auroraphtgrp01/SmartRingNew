export class Constants {
  ...
  static COMMAND_BYTE = {
    ...
    // heart
    HEART_RATE_PREPARE_COMMAND: new Uint8Array([0x03, 0x09, 0x09, 0x00, 0x00, 0x00, 0x02, 0x90, 0xE9]),
    HEART_RATE_START_COMMAND: new Uint8Array([0x03, 0x2F, 0x08, 0x00, 0x01, 0x00, 0x4F, 0x1B]),
    HEART_RATE_STOP_COMMAND: new Uint8Array([0x03, 0x2F, 0x07, 0x00, 0x00, 0xEE, 0x99]),
  }
